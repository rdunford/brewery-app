        ...
        return (
            <div className = 'main_about-container'>
                ...
                <div className='about-container' >
                    ...
                    <p><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque aliquet eu nisl id aliquam. Pellentesque eu viverra magna, 
                    ...
                    <br/> <p>Sed urna neque, auctor elementum blandit 
                    ...
                    <br/> <p>Fusce non nunc elementum, rutrum metus eu,
                    ...
                    neque eu urna cursus dictum. Pellentesque massa nunc, hendrerit ut egestas vitae, lacinia a magna. </p><br/>Suspendisse eu eleifend velit, in congue ipsum. Sed
                    sit amet diam vitae dui volutpat laoreet. Sed vulputate pellentesque mauris at ullamcorper. Quisque bibendum tortor luctus magna interdum elementum. Integer vitae erat velit.
                    Mauris suscipit consequat massa, id dapibus nisl venenatis vel. Integer ut ullamcorper felis, eget sagittis neque. Praesent nec libero ut nisi pharetra rutrum et molestie felis. Aenean 
                    condimentum leo vel ligula mattis vehicula. Quisque ligula est, aliquet at mauris eget, molestie aliquet dolor. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Pellentesque arcu enim, placerat in ex sit amet, bibendum pellentesque velit. Morbi vel justo ut odio condimentum consectetur vitae vel ipsum. Curabitur molestie nibh quis erat finibus, ut auctor odio scelerisque. Aliquam erat volutpat. Cras eget rhoncus nisi, eget euismod nibh.</p>
                    ...
                    semper sapien. Nulla quis lorem sed nulla tristique dictum. Mauris a rutrum ex. Aenean vel pretium augue. Ut sit amet libero quis arcu blandit rhoncus. 
                    Sed eros eros, mattis sit amet viverra non, commodo id turpis. Nulla facilisi. Nunc dignissim feugiat finibus.</p>
                    <br/> <p>Fusce non nunc elementum, rutrum metus eu. Sed urna neque, auctor elementum blandit 
                    at, ultricies non purus. Suspendisse sed rhoncus urna. Sed id lectus at arcu rhoncus ullamcorper. Aliquam ipsum est, sodales vel tincidunt
                    eget, elementum condimentum ipsum. Aenean efficitur metus sodales sem fermentum, non pellentesque odio tempor. Sed euismod, nulla ut ultricies
                    scelerisque, eros nisl fringilla libero, a ornare enim purus vel est. Sed ut ornare dui. Curabitur mauris dui, bibendum et felis nec, tempus 
                    lacinia felis. Pellentesque at nunc vel ante lobortis fringilla a quis lacus. Nunc eget ante nisi. In vel risus convallis, pharetra ante vel,
